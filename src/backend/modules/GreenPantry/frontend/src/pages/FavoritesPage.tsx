...
import { Heart, Star, Clock, MapPin, Search, Filter, Loader2 } from 'lucide-react'
          ...
          <>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredFavorites.map((item) => (
                <div key={item.id} className="bg-white dark:bg-gray-800 rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow duration-200">
                  ...
                  <div className="p-6">
                    ...
                    {item.type === 'restaurant' ? (
                      ...
                      <>
                        <p className="text-gray-600 dark:text-gray-300 mb-2">
                          {item.restaurant || 'N/A'} • {item.category || 'N/A'}
                        </p>
                    ...
                    <div className="flex gap-2 mt-4">
                      <Link
                        to={item.type === 'restaurant' ? `/restaurants/${item.itemId}` : `/restaurants`}
