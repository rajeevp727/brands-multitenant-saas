...
const FavoritesPage = () => {
  ...
  const favoriteRestaurants = [
    ...
    {
      id: 'rameshwaram-cafe-madhapur',
      name: 'The Rameshwaram Cafe',
      cuisine: 'South Indian',
      rating: 4.8,
      deliveryTime: '20 min',
      distance: '1.2 km',
      image: 'https://images.unsplash.com/photo-1589301773012-07755f1a5bd8?w=800',
      priceRange: '₹₹',
    ...
    {
      id: 'pista-house-suchitra',
      name: 'Pista House',
      cuisine: 'Hyderabadi',
      rating: 4.5,
      deliveryTime: '35 min',
      distance: '4.1 km',
      image: 'https://images.unsplash.com/photo-1563379091339-03246963d4d4?w=800',
      priceRange: '₹₹₹',
