...
const HeroSection = () => {
  ...
  useEffect(() => {
    // Automatically ask for geolocation parsing on load
    getCurrentLocation()
  }, [])
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            <div className="text-center">
              <div className="text-3xl font-bold text-secondary-300 mb-2">3</div>
              <div className="text-primary-100">Restaurants</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-secondary-300 mb-2">2,590+</div>
