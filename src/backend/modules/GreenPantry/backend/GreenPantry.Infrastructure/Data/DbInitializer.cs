...
public static class DbInitializer
{
    public static async Task InitializeAsync(AppDbContext context)
    {
        try 
        {
            ...
            // Repair shared Users table schema if columns are NOT NULL
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"Password\" DROP NOT NULL;"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"Password\" SET DEFAULT '';"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"PasswordHash\" DROP NOT NULL;"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"PasswordHash\" SET DEFAULT '';"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"RequestedRole\" DROP NOT NULL;"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"RequestedRole\" SET DEFAULT 'User';"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"LastLogin\" DROP NOT NULL;"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"LastLogin\" SET DEFAULT now();"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"HasVisitedFromDomain\" DROP NOT NULL;"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"HasVisitedFromDomain\" SET DEFAULT false;"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"HasSeenCta\" DROP NOT NULL;"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"HasSeenCta\" SET DEFAULT false;"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"Role\" DROP NOT NULL;"); } catch {}
            try { await context.Database.ExecuteSqlRawAsync("ALTER TABLE \"Users\" ALTER COLUMN \"Role\" SET DEFAULT 0;"); } catch {}
        ...
        {
            Console.WriteLine($"[CRITICAL] Database initialization failed but suppression is active: {ex.Message}");
